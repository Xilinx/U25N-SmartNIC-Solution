...
#define MAX_ESWITCHES			2
#define MAX_VFS_PER_SWITCH		15
#define MAX_PORTS_PER_SWITCH		MAX_VFS_PER_SWITCH + 1

#ifndef XILINX_MAC_DEBUG
#define SKB_QUEUE_LEN		32
...
struct axienet_local {
	...
	struct sk_buff_head *granted_q;
	struct sk_buff *skbuff[SKB_QUEUE_LEN];
	struct sock *nl_sk;
	struct workqueue_struct *grant_work_q;
        struct delayed_work grant_work;
...
#endif
void efx_mae_stats_send(struct work_struct *work);
