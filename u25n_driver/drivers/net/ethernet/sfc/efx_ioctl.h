...
#define IPSEC_OFFLOAD_ADD_SA_ENC (SIOCDEVPRIVATE + 4)
#define IPSEC_OFFLOAD_ADD_SA_DEC (SIOCDEVPRIVATE + 5)
#define IPSEC_OFFLOAD_ADD_POLICY (SIOCDEVPRIVATE + 6)
#define IPSEC_OFFLOAD_DEL_SA_ENC (SIOCDEVPRIVATE + 7)
#define IPSEC_OFFLOAD_DEL_SA_DEC (SIOCDEVPRIVATE + 8)
#define IPSEC_OFFLOAD_QUERY_SA   (SIOCDEVPRIVATE + 9)

#define FPGA_OPERATION           (SIOCDEVPRIVATE + 10)
#define FLASH_OPERATION          (SIOCDEVPRIVATE + 11)
...
#define RESET                    (4)
#define GET_STATUS               (5)
#define CHECK_IFACE              (6)
#define CHECK_LINK               (7)
#define FPGA_VERSION             (8)
#define FW_VERSION		 (9)
#define BITSTR_VERSION		 (10)
#define APP_IN_PS                (11)
#define FLASH_INDEX              (12)
#define CHECK_U25                (13)
